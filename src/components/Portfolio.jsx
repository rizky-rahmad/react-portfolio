                ...
                <div className="container">
                    <div className="isotope-layout" data-default-filter="*" data-layout="masonry" data-sort="original-order">
                        ...
                        <div className="row gy-4 isotope-container" data-aos="fade-up" data-aos-delay="200">
                            ...
                            <div className="col-lg-4 col-md-6 portfolio-item isotope-item filter-website">
                                <img src="assets/img/portfolio/to-do-list.jpg" className="img-fluid" loading="lazy" decoding="async"
                                    alt="Screenshot of To-Do List application project" />
                                <div className="portfolio-info">
                                    <h4>Node.js-To-Do-List</h4>
                                    <p>A full-stack To-Do List application with CRUD operations using Node.js, Express, and PostgreSQL.</p>
                                    <a href="assets/img/portfolio/to-do-list.jpg" data-gallery="portfolio-gallery-branding"
                                        className="glightbox preview-link"
                                        title="A full-stack To-Do List application. This project demonstrates CRUD operations (Create, Read, Update, Delete) using Node.js and Express. It connects to a PostgreSQL database to manage tasks and uses EJS for the front-end rendering. Key features include adding new tasks, deleting completed tasks, and editing existing ones."><i
                                            className="bi bi-zoom-in"></i></a>
                                ...
                                <img src="assets/img/portfolio/MI 1.jpg" className="img-fluid" loading="lazy" decoding="async"
                                    alt="Screenshot of D3 Manajemen Informatika web profile" />
                                <div className="portfolio-info">
                                    <h4>Web Profile</h4>
                                    <p>D3 Manajemen Informatika</p>
                                    <a href="assets/img/portfolio/MI 1.jpg" data-gallery="portfolio-gallery-branding"
                                        className="glightbox preview-link"
                                        title="Developing Web Profile for my College Major Office. Built in Drupal Framework and i'm using this as my Final Project"><i
                                            className="bi bi-zoom-in"></i></a>
                                    <a href="assets/img/portfolio/MI 1.jpg" target="_blank" title="More Details" className="details-link"><i
                                        className="bi bi-link-45deg"></i></a>
                                </div>
                            </div>
                            <div className="col-lg-4 col-md-6 portfolio-item isotope-item filter-website">
                                <img src="assets/img/portfolio/web1.jpg" className="img-fluid"
                                ...
                                <div className="portfolio-info">
                                    ...
                                    <a href="assets/img/portfolio/web1.jpg" data-gallery="portfolio-gallery-product"
                                        className="glightbox preview-link"
